...
function kehadiran() {
  ...
  class MEME_CHAT{
    ...
    home(){
      ...
      // document.getElementById.innerHTML = 'ww-rsvp'
    ...
    create_join_form(){
      ...
      join_input.placeholder = 'Silahkan isi nama anda'
    ...
    create_chat(){
      ...
      chat_input.placeholder = `${parent.get_name()}. Kirim ucapan dan doanya ya...`
